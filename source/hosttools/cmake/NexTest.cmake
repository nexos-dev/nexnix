...
function(nextest_add_library_test)
    if("${__NEXTEST_TESTS_ENABLED}" EQUAL "1")
        ...
        cmake_parse_arguments(__TESTARG "" 
                              "NAME;SOURCE;WORKDIR;LINK_LANG;LANGUAGE" 
                              "DEFINES;LIBS;INCLUDES" ${ARGN})
        ...
        if(NOT __TESTARG_LINK_LANG)
            set(__TESTARG_LINK_LANG "C")
        endif()
        ...
        set_target_properties(${__TESTARG_EXENAME} PROPERTIES LINKER_LANGUAGE ${__TESTARG_LINK_LANG})
